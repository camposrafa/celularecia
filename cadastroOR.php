<?php
	...
	if( isset($_POST) && !empty($_POST) ){
		...
		$resultado = $bd->query("INSERT INTO # esta variável receberá um valor verdairo ou falso, se houve realmente a inserção no banco
									orcamento (NOME,TELEFONE,APARELHO,CONSERTO,VALOR,OBSERVACAO)
								VALUES
									('$cNome','$cTelefone','$cAparelho','$cConserto','$cValor','$cObservacao');");
		if($resultado){
			echo "<script>
...
<html lang="pt-BR">
	<head>
		...
		<title>Cadastro de Orçamento - Celular&Cia</title>
	...
	<nav class="navbar navbar-dark bg-dark">
		...
		<div class="jumbotron">
			<div class="container">
				<center><h4><p>Preencha as informações abaixo para incluir um novo orçamento.</p></h4></center>
			</div>
		</div>
			  ...
			  <div class="panel-body">
				<form method="POST">
					...
					<div class="form-group">
						...
						<input type="text" name="campoObservacao" class="form-control" placeholder="Ex.: Data específica" required="required" />
					</div>
					<center>
